...
{
    //this class is very temporary and still has multiplayer bugs
    //ill make a full on interface for healthbars later, I don't have the mental capacity for it yet
    public class CriticalShield
    {
        ...
        public abstract class CriticalShieldBehavior : BaseItemBodyBehavior
        {
            ...
            private float cachedFractionalValue;
            ...
            public void UpdateBar(RoR2.UI.HealthBar healthBar)
            {
                ...
                if (!image)
                {
                    //reinstantiate image if the image doesn't exist
            ...
            public void SetRectPosition(RectTransform rectTransform, float xMin, float xMax, float sizeDelta)
            {
