...
{
    [PostProcess(typeof(SlipSobelRainRenderer), PostProcessEvent.BeforeTransparent, "Slip/SobelRain", true)]
    [Serializable]
    public sealed class SlipSobelRain : PostProcessEffectSettings
    {
		[Range(0f, 100f)]
